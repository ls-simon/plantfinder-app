        ...
        <div className="text-lg text-center mx-auto flex grid grid-cols-2 grid-fixed mt-5 ml-5 mr-15">
          <div className=" text-left" style={{ paddingRight: "20px" }}>
            <ul>
              ...
              <hr className="mr-5" />
              <li>
                <b style={{ fontSize: "20px" }}>Gruppe</b>
                <br />
                {selectedTab ? selectedTab.item.description.group : "Ukendt"}
              </li>
              <hr className="mr-5"></hr>
              <li>
                <b style={{ fontSize: "20px" }}>Familie</b>
                <br />
                {selectedTab ? selectedTab.item.description.family : "Ukendt"}
              </li>
              <hr className="mr-5"></hr>
              <li>
                <b style={{ fontSize: "20px" }}>Vokser i</b>
                <br />
                {selectedTab
                  ? selectedTab.item.description.blooming_period
                  : "Ukendt"}
              </li>
              <hr className="mr-5"></hr>
            </ul>
          </div>
          <div className="object-center ml-10 ">
            <img
              src={selectedTab ? selectedTab.item.image : ""}
              style={{
                borderRadius: "20%",
                maxWidth: "400px",
                maxHeight: "250px",
            ...
            <div className="text-lg grid grid-cols-2 gap-4 ml-5 mr-10 ">
              <div className="span-1 ml-10">
                <ul>
                  ...
                  <li>Type:</li>
                  <li>
                    {selectedTab && selectedTab.diceRoll.type.valueHeader}
                  </li>
                  <li>Værdi:</li>
                  <li>Udvinding: </li>
                  <li>Form:</li>
